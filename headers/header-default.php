...
$disable_candidate_register = function_exists('iwj_option') ? iwj_option('disable_candidate_register', 'yes') : '';
$disable_employer_register = function_exists('iwj_option') ? iwj_option('disable_employer_register', 'yes') : '';
